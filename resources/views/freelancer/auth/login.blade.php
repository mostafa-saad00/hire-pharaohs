...
<body class="bg-gray-200 h-screen flex items-center justify-center">
  <div class="w-full max-w-xs">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('freelancer.login') }}" method="post">
        @csrf
      <label for="freelancerLoginText">Freelancer Login</label>
      <div class="mb-4">
